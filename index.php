...
<head>
    ...
    <link rel='stylesheet' href='.\dtdo_style.css' type='text/css' media='all' />
    <link rel="icon" type="image/x-icon" href="/SPRP/php/FA/dopstodo/assets/favicon_todo.ico">
...
<body class="changelocked">
	...
	<div class="title">
			<h1 class="text-center font-weight-bold ta-center"><img width="300" src="./assets/Logo_dopstodo.png"> </h1>
	...
	<div class="wrappercontent">
		...
		<h5 class="text-center text-subtitle ilineless topfading "> TO DO , ROADMAP DOPS   </h5>
...
<div class="Content_container">
		...
		<p>Taches a réaliser dans le mois courant :</p>
